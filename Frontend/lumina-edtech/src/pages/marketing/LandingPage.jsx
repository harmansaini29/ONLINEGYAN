  ...
  <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0B0C15]/80 backdrop-blur-md">
    <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <button className="text-sm font-medium text-white hover:text-indigo-300 transition-colors">Log In</button>
  ...
  return (
    <div className="min-h-screen bg-[#0B0C15] text-white font-sans overflow-x-hidden selection:bg-indigo-500/30">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6">
        ...
        <div className="absolute top-0 left-0 right-0 h-[800px] bg-mesh opacity-40 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold transition-all shadow-[0_0_40px_rgba(99,102,241,0.3)] flex items-center justify-center gap-2">
